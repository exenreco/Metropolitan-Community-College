                ...
                for ($i = 0; $i < count($recentOrders); $i++)
                    {
                        ...
                        <div class=\"media\">
                            <a class=\"pull-left\" href=\"#\">
                                <img class=\"media-object\" src=\"" . $recentOrders[$i]["filename"] . "\" alt='...'>
                            </a>
                            <div class=\"media-body\">
                                <p class=\"media-heading similarTitle\"><a href=\"#\">" . $recentOrders[$i]['title'] . "</a></p>
                                <em>" . $recentOrders[$i]['time'] . " minutes ago</em>
                            </div>
                        </div>";
                    }
            ?>
